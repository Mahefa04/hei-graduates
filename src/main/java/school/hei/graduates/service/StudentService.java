...
public class StudentService {
  ...
  public List<StudentGroupHistoryResponse> getGroupHistory(UUID studentId) {
    ...
    return studentGroupHistoryRepository.findByStudent_IdOrderByStartDateAsc(studentId).stream()
  ...
  public StudentGroupHistoryResponse changeGroup(UUID studentId, UUID groupId) {
    ...
    var currentGroup =
        studentGroupHistoryRepository.findFirstByStudent_IdAndEndDateIsNull(studentId);
    ...
    StudentGroupHistory savedHistory = studentGroupHistoryRepository.save(newHistory);
